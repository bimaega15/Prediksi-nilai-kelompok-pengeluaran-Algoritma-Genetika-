        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a data-toggle="modal" data-target="#modalForm" href="<?= base_url('Admin/Kategori/add') ?>" class="btn btn-primary btn-add"><i class="fas fa-plus-circle"></i> Tambah Data</a>
...
<!-- Modal -->
<div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="modalFormKategori" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalFormKategori"> Form Kategori</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('Admin/Kategori/process') ?>" method="post" class="form-submit">
...
<script>
    $(document).ready(function() {
        var table = $('#dataTable').DataTable({
            "ajax": "<?= base_url('Admin/Kategori/loadData') ?>",
        });
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                url: '<?= base_url('Admin/Kategori/edit/') ?>' + id_kategori,
                method: 'get',
                dataType: 'json',
                success: function(data) {
                    ...
                    $('input[name="id_kategori"]').val(row.id_kategori);
                    $('input[name="nama_kategori"]').val(row.nama_kategori);
        ...
        $(document).on('click', '.btn-submit', function(e) {
            ...
            $.ajax({
                url: '<?= base_url('Admin/Kategori/process') ?>',
                type: "POST",
                data: data,
